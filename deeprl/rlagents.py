...
class AgentMeta:
    ...
    def __init__(self, env, seed, config, device='cpu', net_model=FCnet):
        """
        Args:
...
class DQNAgent(AgentMeta):
    ...
    def __init__(self, env, seed, config, device='cpu', net_model=FCnet):
        ...
        Args:
            ...
            seed (int):     random seed
        """
        super().__init__(env, seed, config, device, net_model)
...
class A2CAgent(AgentMeta):
    ...
    def __init__(self, env, seed, config, device='cpu', net_model=ActorNet):
        """
        Args:
            env:            initialized environment class
            seed (int):     random seed
